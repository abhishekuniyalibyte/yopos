...
(function () {
  ...
  var CSS = [
    ...
    ".yop-log{flex:1;overflow-y:auto;padding:15px;display:flex;flex-direction:column;gap:11px}",
    ...
    ".yop-cart{border-top:1px solid #e2e2dd;padding:10px 15px;font-size:13px;background:#fafaf8}",
